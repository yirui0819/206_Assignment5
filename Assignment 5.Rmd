...
graph_salary <- ggplot(doc_salary, aes(x= factor(field,levels = rev(levels(factor(field)))), y = salary/1000)) +
  geom_col(aes(fill = sex), position = "dodge") +
  facet_wrap(~postgrad_plan) +
  theme_classic() +
  labs(x = "Subject", y = "Median Salary of Doctoral Recipients (thousand dollar)") +
